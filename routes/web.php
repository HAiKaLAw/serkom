...
Route::get('/formulir', [PesertaController::class, 'create'])->name('peserta.create');
Route::post('/formulir', [PesertaController::class, 'store'])->name('peserta.store');
Route::get('/skema', [SkemaController::class, 'create'])->name('skema.create');
